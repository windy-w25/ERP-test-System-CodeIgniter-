<h2 style="color: #4CAF50; margin-left: 50px;">Create Item</h2>
<form method="post" style="max-width: 500px; margin-left: 50px; padding: 20px; background-color: #f9f9f9; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <input type="text" name="name" value="<?= set_value('name') ?>" style="width: 100%; padding: 10px; margin: 8px 0; border: 1px solid #ddd; border-radius: 4px;"><br>

    <label for="price" style="color: #333;">Price:</label><br>
    <input type="text" name="price" value="<?= set_value('price') ?>" style="width: 100%; padding: 10px; margin: 8px 0; border: 1px solid #ddd; border-radius: 4px;"><br>

    <label for="description" style="color: #333;">Description:</label><br>
    <textarea name="description" style="width: 100%; padding: 10px; margin: 8px 0; border: 1px solid #ddd; border-radius: 4px; height: 100px;"><?= set_value('description') ?></textarea><br>
    ...
    <?= form_error('unit_id', '<div class="error-message">', '</div>'); ?>
