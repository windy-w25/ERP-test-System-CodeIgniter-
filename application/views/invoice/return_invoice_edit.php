...
<input type="text" value="<?= $invoice->return_no ?>" readonly>
...
<input type="date" id="return_date" value="<?= $invoice->return_date ?>">
...
$(document).ready(function(){
    ...
    $('#update_invoice').click(function(){
        ...
        $.ajax({
            url: '<?= site_url("return_invoice/update/".$invoice->id) ?>',
            type: 'POST',
            data: {
            ...
            success: function(response){
                ...
                if(response.status == 'success'){
                    window.location.href = '<?= site_url("return_invoice") ?>';
                }
            }
        });
